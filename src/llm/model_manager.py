...
class ModelManager:
    ...
    def load_model(
        self, model_name: str, dtype_name: str, revision: str | None = None
        ...
        # revision pins a commit; `main` moves, which would silently change
        # the weights a benchmark is comparing.
